const strings = {
  ...
  activity_signup_camera_text_1:
    'You will next see a popup requesting access to your Camera.',
  activity_signup_camera_text_2:
    'This is necessary to scan QR codes to pay people and merchants.',
  activity_signup_camera_permission_1: '"Edge" would like to access the camera',
  ...
  activity_signup_contact_text_1:
    'You will next see a popup requesting access to your Contacts.',
  activity_signup_contact_text_2:
    'Edge uses contacts to help tag information regarding your transactions.',
  activity_signup_contact_text_3:
    'All tagged information is kept 100% private and encrypted by your password.',
  activity_signup_contact_text_4:
    'No one, including Edge, has any access to this information.',
  activity_signup_password_label: 'Enter Password',
  activity_splash_with_airbitz: 'Sign in with Edge',
  loading: 'Loading…',
  ...
  string_no_connection_pin_message:
    'You are offline but can still login to your account.',
  string_no_connection_response:
    'There is a problem reaching the server. Please try again.',
  ...
  no_location_found:
    'Unable to get a current location. Please enable Location Services.',
  ...
  fragment_business_enable_location_services:
    'Enable location services for better results',
  fragment_business_no_categories_retreived:
  ...
  fragment_directory_detail_no_phone:
    'No Activity installed to handle a phone call.',
  ...
  server_error_account_does_not_exists:
    'We were unable to find your account. Be sure your username is correct.',
  ...
  server_error_no_connection:
    'Unable to connect to server. Please try again later.',
  server_error_no_recovery_questions:
    'No recovery questions are available for this user',
  ...
  server_error_invalid_pin_wait:
    'Too many failed login attempts. Please try again in %1$s seconds.',
  ...
  fragment_forgot_no_recovery_questions_text:
    'This user does not have any recovery questions set!',
  fragment_landing_account_delete_title: 'Delete Account',
  fragment_landing_account_delete_message:
    'Delete {0} on this device only? This will remove the 2FA and PIN access from this device. If 2FA is enabled on this account, you will be unable to access this account for 7 days from new devices',
  ...
  activity_signup_password_help:
    'Password must have an upper and lower case letter, a number, and a minimum 10 characters',
  ...
  fragment_setup_footer_2_link: 'Download Edge & Enable 2FA',
  ...
  activity_recovery_prompt_skip:
    '**WARNING** You will NEVER be able to recover your password if it is forgotten!!',
  activity_recovery_first_wallet_name: 'My Wallet',
  activity_recovery_answer_questions_alert:
    'You must answer all questions. Make sure your answers are long enough.',
  activity_recovery_pick_questions_alert:
  ...
  activity_recovery_error_incorrect_password:
    'Please enter your correct password so your answers can be changed',
  ...
  activity_recovery_error_wrong_answers_message:
  ...
  activity_recovery_warning_dirty_forgot_message:
    'Warning: You are about to exit password recovery and all progress will be lost. Exit anyway?',
  ...
  fragment_recovery_account_created_fragment_1:
    'Your {0} account has been created.',
  fragment_recovery_account_created_fragment_2:
    'Your username and password are known only to you and cannot be reset by {0}.',
  fragment_recovery_account_created_fragment_3:
  ...
  settings_nfc_turn_on_message:
    'NFC is used to enable tap-to-pay with supported merchants. Would you like to turn it on now?',
  settings_ble_turn_on_title: 'Activate Bluetooth',
  settings_ble_turn_on_message:
    'Bluetooth is used to allow payments wirelessly without needing to scan a QR code. Would you like to turn it on now?',
  ...
  fragment_spending_limits_daily_subtext:
    '(Requires password above daily limit)',

  //  Strings for Category Fragment
  fragment_category_cancel_title: 'Cancel Changes',
  fragment_category_cancel_message:
  ...
  fragment_send_incorrect_pin_message:
    'You must enter the correct PIN in order to proceed',
  fragment_send_incorrect_pin_title: 'Invalid PIN',
  fragment_send_incorrect_password_message:
    'You must enter the correct Password in order to proceed',
  ...
  fragment_send_first_usage_ble:
    'Bluetooth payment requests are listed here. Tap on a user to send them a payment',
  ...
  fragment_send_address_dialog_title:
    'Send to Bitcoin Address or Import Private Key',
  ...
  fragment_send_create_wallet_to_transfer:
  ...
  fragment_send_confirmation_insufficient_funds_message:
  ...
  fragment_send_confirmation_pin_remaining:
    'Invalid PIN. Please wait %1$.0f seconds and try again…',
  fragment_send_confirmation_password_remaining:
    'Incorrect Password. Please wait %1$.0f seconds and try again…',
  ...
  fragment_send_confirmation_error_payment_processor:
    'Error connecting to payment processor. Send directly to bitcoin address\n\n%s',
  ...
  fragment_wallets_delete_has_funds:
    'Cannot delete wallet as it contains funds. Please transfer out funds first.',
  fragment_wallets_delete_wallet_confirm_title: 'Delete Wallet?',
  fragment_wallets_delete_wallet_confirm_message:
  ...
  fragment_wallets_archive_help:
    'To archive a wallet, tap and hold the 3 dots to the right of a wallet and drag it below the [ARCHIVE] header',
  ...
  fragment_transaction_list_rbf:
    'Warning: Replace by Fee Detected. Double spend likely',
  ...
  address_request_message:
    '{0} has requested a bitcoin address to send money to. Please choose a wallet to receive funds.',
  ...
  request_qr_image_store_error:
    'Warning: The QR code cannot be attached to the email.',
  ...
  request_qr_ble_advertise_start_failed:
    'Bluetooth advertising failed to start.',
  request_qr_ble_invalid_value:
    'Bluetooth sender sent an invalid name. Try again.',
  request_qr_ble_invalid_service:
    '{0} could not advertise the Bluetooth service. Please check Bluetooth on your device.',
  request_qr_ble_invalid_uri:
    'You received an invalid bitcoin request. You can try again.',
  request_qr_ble_copied: 'Request is copied to the clipboard.',
  request_qr_first_usage:
    'Present QR code to Sender and have them scan to send you payment',
  ...
  import_wallet_hidden_bits_error_message:
    'Failed to import because there is 0 bitcoin remaining at this address',
  ...
  transaction_details_outputs_unavailable:
    'The outputs to this transaction are unavailable at this time.',
  ...
  transaction_details_recovery_reminder_message:
    "You've received Bitcoin! We STRONGLY recommend setting up Password Recovery questions and answers. Otherwise you will NOT be able to access your account if your password is forgotten.",
  ...
  transaction_details_transaction_save_failed:
    'Unable to save all transaction data',
  ...
  export_saving_option_no_transactions_message:
    'There are no transactions to export in your date range',
  export_saving_option_email_subject: 'Edge Bitcoin Wallet Transactions',
  export_saving_option_no_email_apps:
  ...
  fragment_map_directory_unable_create_map:
    'Sorry! unable to create maps, check for updates to Google Play Services',

  //  Strings for BluetoothListView
  bluetoothlistview_connection_failed:
    'Bluetooth connection failed. Try again.',
  bluetoothlistview_discovery_failed:
    'Bluetooth service discovery failed. Try again.',
  ...
  bluetoothlistview_address_mismatch_message:
    'The bitcoin address of the device you connected with:{0} does not match the address that was initially advertised:{1}',
  ...
  user_review_play_store:
    'Would you like to write a review in the Google Play Store?',
  ...
  fragment_twofactor_show_unable_status:
    'Unable to determine two factor status',
  ...
  fragment_twofactor_show_reset_requested:
    '2FA Reset Requested by another device.',
  ...
  twofactor_unable_import_token:
    'We are sorry we are unable to import the token at this time.',

  fragment_two_factor_scan_unable_import_title: 'Unable to import token',
  fragment_two_factor_scan_unable_import_message:
    'The two factor authentication token import failed. Please ensure you have the correct token!',
  ...
  fragment_two_factor_warn_message:
    'If you lose your device or uninstall the {0} app, it will take 7 days to disable 2FA and access your account.',

  twofactor_reset_message:
    'A two factor reset has been requested. Please login as {0} and approve or cancel the request.',
  ...
  remote_password_change_message:
    'The Password to this account was changed by another device. Please login using the new credentials',
  received_bitcoin_title: 'Received Bitcoin',
  received_bitcoin_message:
    'Received {0}(~{1}).\nTap Details to see transaction.',
  received_bitcoin_fading_message: 'You received Bitcoin!\n{0} (~{1})\n',
  received_bitcoin_fading_message_teaching:
    'Use the Payee, Category, and Notes field to optionally tag your transaction',
  ...
  password_check_skip:
    'Please create a new account and transfer your funds if you forgot your password.',
  ...
  upload_log_alert_message:
    'Enter any notes you would like to send to our support staff',
  ...
  password_set_message:
    'Please create a password for this account or you will not be able to recover your account if your device is lost or stolen',
  password_set_skip: 'Skip',

  //  PIN Set
  pin_set_title: 'No PIN set',
  pin_set_message:
    'Please create a PIN for this account to enable quick re-logins',
  ...
  //  Logout
  logout_message:
    'Please wait while {0} gracefully exits your account. This may take a while on slow networks',
  ...
  affiliate_link_share_text:
    'Download the Edge wallet and save money using bitcoin',
  ...
  transaction_footer_import_gift_card: 'Import Edge Gift Card',
  ...
  recovery_token_email_body:
    'Please click the link below from a mobile device with {0} installed to initiate account recovery for username [{1}]\n\n&lt;br&gt;&lt;br&gt;{2}',
  enter_username_to_recover:
    'Please enter the username of the account to recover',
  ...
  recovery_not_setup4:
    'If recovery was setup, you should have emailed yourself a recovery token with a link. To recover your account, install the Edge Mobile App on iOS or Android',
  recovery_not_setup5:
    'Then click one of the links in the recovery email from a device with Edge installed',
  recovery_token_invalid:
    'Incorrect username for this recovery token. Please try a different username or use a different recovery token link.',
  logout_before_recovery:
    'Please logout of current account before attempting password recovery',
  recovery_successful:
    'Recovery Successful\n\nPlease change your password and PIN',
  invalid_email: 'Invalid Email',
  disable_recovery_popup_title: 'Disable Recovery?',
  disable_recovery_popup_message:
    'This account already has password recovery setup. Would you like to disable it?',
  error_disabling_recovery: 'Error disabling recovery',
  recovery_disabled: 'Recovery Disabled',
  recovery_setup_successful:
    'Password recovery setup complete. Please ensure you retain a copy of the email you sent yourself. Use the link in the email to recovery your account if your password is forgotten.',
  in: 'in',
  ...
  edge_login_manage:
    'Login to the Edge Wallet to change your password/PIN or setup password recovery',
  edge_description:
    'This application would like to access the following repositories linked to your Edge account. It will not have access to any other accounts or wallets.',
  ...
  verify_domain_and_approve:
    'Please verify the domain above and tap LOGIN to authenticate with this site',
  error_edge_login:
  ...
  identity_token_created_and_saved:
    'Identity token from [{0}] created and saved',
  successfully_verified_identity: 'Successfully Verified Identity',
  create_new_text: 'Create new',
  or_choose: '"$1$s" or choose',

  request_your_identity_token:
    'Request your Identity Token. Please select one below',
  request_your_identity_token_but_none:
    "Request your Identity Token but you don't have any",
