...
export default ({
  ...
  >
    ...
    <p className={styles.text}>
      ...
      <a target='_blank' rel="noopener noreferrer" href='https://airbitz.co/app' className={styles.linked}>https://airbitz.co/app</a>
    </p>
    <p className={styles.text}>
      Then click one of the links in the recovery email from a device with Airbitz installed.
    </p>
    <button className={styles.close} onClick={close}>Ok</button>
  </Modal>
)
