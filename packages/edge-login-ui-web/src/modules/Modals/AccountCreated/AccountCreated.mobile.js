...
export default ({
  ...
  >
    ...
    <p className={styles.heavy}>Your username and password are known only to you and cannot be reset by {name}.</p>
    ...
    <div className={styles.customButtons}>
      <button className={styles.secondaryMobile} onClick={cancel}>I'll do it later</button>
      <button className={styles.primaryMobile} onClick={submit}>Setup Recovery</button>
    </div>
  </Modal>
)
