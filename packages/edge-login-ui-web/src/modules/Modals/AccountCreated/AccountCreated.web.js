...
export default ({
  ...
  >
    <div className={styles.container}>
      ...
      <p className={styles.p2}>Your username and password are known only to you and cannot be reset by {name}.</p>
      ...
      <div className={styles.rowButtons}>
        <button className={styles.secondary} onClick={cancel}>I&apos;ll do it later</button>
        <button className={styles.primary} onClick={submit}>Setup Recovery</button>
      </div>
    </div>
  </Modal>
)
