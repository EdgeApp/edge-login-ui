...
export default ({
    ...
    if (view) {
      return (
        <p className={styles.shown}>
          <span className={styles.bold}>Username:</span> {details.username} <br />
          <span className={styles.bold}>Password:</span> {details.password} <br />
  ...
  return (
    <div className={styles.container}>
      ...
      <button className={styles.primaryMobile} onClick={handleOpenAccountCreatedModal}>Finish</button>
    </div>
  )
}
