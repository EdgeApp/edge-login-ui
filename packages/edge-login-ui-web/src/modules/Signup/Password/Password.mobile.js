    ...
    if (!loader) {
      return (
        <div className={styles.rowButtonsHorizontalMobile}>
          ...
          <button className={styles.secondaryMobile} onClick={gotoPin}>Back</button>
        </div>
      )
    }
    if (loader) {
      ...
      <div className={styles.formContainer}>
        <div className={styles.formWithIcon}>
          <Input
            ...
            ref={refPassword}
          />
          <img src={inputState ? eyeHide : eyeShow} className={styles.icon} onClick={toggleRevealPassword} />
        </div>
        <Input
          type={inputState ? 'text' : 'password'}
