  ...
  <div className={styles.container}>
    <div className={styles.text1Container}>
      <p className={styles.text1}>
        <a href='https://airbitz.co/app' target='_blank' rel="noopener noreferrer">
    ...
    <div className={styles.text2Container}>
      ...
      <p className={styles.text2}>
        Powered by <a href='https://airbitz.co/app' target='_blank' rel="noopener noreferrer" className={styles.link}>Edge</a>
      </p>
    </div>
  </div>
)
