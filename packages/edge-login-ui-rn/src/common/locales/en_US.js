...
const strings = {
  ...
  create_account_error_message:
    'An error occurred creating your account. This may have been due to a slow network connection or network interruption. If you receive another error that the account already exists, please restart the app and login with your username and password.',
  try_again: 'Try Again'
}
