export default {
  ...
  terms_three:
    'I understand that if I lose my username and password, %s will not be able to recover my account, unless I set up password recovery',
  terms_four:
