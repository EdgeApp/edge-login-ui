const strings = {
  ...
  activity_signup_contact_text_2: 'Edge uses contacts to help tag information regarding your transactions.',
  activity_signup_contact_text_3: 'All tagged information is kept 100% private and encrypted by your password.',
  activity_signup_contact_text_4: 'No one, including Edge, has any access to this information.',
  ...
  server_error_bad_otp: 'This account has Two Factor Authentication enabled and cannot be logged in using a username and password. Please login by scanning the barcode with the Edge Wallet.',
  ...
  affiliate_link_share_text: 'Download the Edge wallet and save money using bitcoin',
  ...
  request_footer: 'Sent from the Edge Mobile Bitcoin Wallet + Business Directory',
  ...
  recovery_not_setup4: 'If recovery was setup, you should have emailed yourself a recovery token with a link. To recover your account, install the Edge Mobile App on iOS or Android',
  recovery_not_setup5: 'Then click one of the links in the recovery email from a device with Edge installed',
