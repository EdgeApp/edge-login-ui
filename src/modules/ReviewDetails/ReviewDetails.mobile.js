...
import AccountCreated from '../Modals/AccountCreated/AccountCreated.mobile.js'
...
class Review extends Component {
  ...
  _cancel = () => {
    ...
    if (!abcuiCallback.loginCallback) {
      this.props.dispatch(closeAccountCreatedModal())
  ...
  render () {
    return (
      <div className={styles.container}>
        ...
        <button className={styles.primaryMobile} onClick={e => this.props.dispatch(openAccountCreatedModal())}>Finish</button>
